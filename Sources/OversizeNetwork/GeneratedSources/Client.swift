...
public struct Client: APIProtocol {
    ...
    public func getAppUpdates(_ input: Operations.getAppUpdates.Input) async throws -> Operations.getAppUpdates.Output {
        try await client.send(
            input: input,
            forOperation: Operations.getAppUpdates.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/v1/apps/{}/updates",
                    parameters: [
                        input.path.id
                    ]
                )
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Components.Responses.VersionsResponse.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Responses.VersionsResponse.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    public func getAppUpdate(_ input: Operations.getAppUpdate.Input) async throws -> Operations.getAppUpdate.Output {
        try await client.send(
            input: input,
            forOperation: Operations.getAppUpdate.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/v1/apps/{}/updates/{}",
                    parameters: [
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Responses.VersionResponse.Body.jsonPayload.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
