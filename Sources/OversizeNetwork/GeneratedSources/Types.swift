...
public extension APIProtocol {
    ...
    /// - Remark: HTTP `GET /v1/apps`.
    /// - Remark: Generated from `#/paths//v1/apps/get(getApps)`.
    func getApps(headers: Operations.getApps.Input.Headers = .init()) async throws -> Operations.getApps.Output {
    ...
    /// - Remark: HTTP `GET /v1/sale-offers`.
    /// - Remark: Generated from `#/paths//v1/sale-offers/get(getSaleOffers)`.
    func getSaleOffers(headers: Operations.getSaleOffers.Input.Headers = .init()) async throws -> Operations.getSaleOffers.Output {
    ...
    /// - Remark: HTTP `GET /v1/infos`.
    /// - Remark: Generated from `#/paths//v1/infos/get(fetchInfo)`.
    func fetchInfo(headers: Operations.fetchInfo.Input.Headers = .init()) async throws -> Operations.fetchInfo.Output {
    ...
    /// - Remark: HTTP `GET /v1/health-check`.
    /// - Remark: Generated from `#/paths//v1/health-check/get`.
    func get_sol_v1_sol_health_hyphen_check(headers: Operations.get_sol_v1_sol_health_hyphen_check.Input.Headers = .init()) async throws -> Operations.get_sol_v1_sol_health_hyphen_check.Output {
