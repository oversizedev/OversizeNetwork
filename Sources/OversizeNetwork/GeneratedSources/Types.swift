...
public protocol APIProtocol: Sendable {
    ...
    /// Retrieve application update history
    ///
    /// Get all version updates associated with a specific application
    ///
    /// - Remark: HTTP `GET /v1/apps/{id}/updates`.
    /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/get(getAppUpdates)`.
    func getAppUpdates(_ input: Operations.getAppUpdates.Input) async throws -> Operations.getAppUpdates.Output
    /// Retrieve application version details
    ///
    /// Get details for a specific version of an application
    ///
    /// - Remark: HTTP `GET /v1/apps/{id}/updates/{version}`.
    /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/{version}/get(getAppUpdate)`.
    func getAppUpdate(_ input: Operations.getAppUpdate.Input) async throws -> Operations.getAppUpdate.Output
...
extension APIProtocol {
    ...
    /// - Remark: HTTP `GET /v1/apps/{id}/updates/{version}`.
    /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/{version}/get(getAppUpdate)`.
    public func getAppUpdate(
        path: Operations.getAppUpdate.Input.Path,
        headers: Operations.getAppUpdate.Input.Headers = .init()
    ) async throws -> Operations.getAppUpdate.Output {
        try await getAppUpdate(Operations.getAppUpdate.Input(
            path: path,
            headers: headers
        ))
    }
...
public enum Components {
    ...
    public enum Schemas {
        ...
        public struct Version: Codable, Hashable, Sendable {
            ...
            public var whatsNew: Swift.String?
    ...
    public enum Parameters {
        ...
        ///
        /// - Remark: Generated from `#/components/parameters/AppBundleId`.
        public typealias AppBundleId = Swift.String
    ...
    public enum Responses {
        ...
        public struct VersionsResponse: Sendable, Hashable {
            /// - Remark: Generated from `#/components/responses/VersionsResponse/content`.
            @frozen public enum Body: Sendable, Hashable {
                /// List of application versions
                ///
                /// - Remark: Generated from `#/components/responses/VersionsResponse/content/json`.
                public struct jsonPayload: Codable, Hashable, Sendable {
                    /// Collection of application versions
                    ///
                    /// - Remark: Generated from `#/components/responses/VersionsResponse/content/json/versions`.
                    public var versions: [Components.Schemas.Version]
                    /// Creates a new `jsonPayload`.
                    ///
                    /// - Parameters:
                    ///   - versions: Collection of application versions
                    public init(versions: [Components.Schemas.Version]) {
                ...
                /// - Remark: Generated from `#/components/responses/VersionsResponse/content/application\/json`.
                case json(Components.Responses.VersionsResponse.Body.jsonPayload)
                /// The associated value of the enum case if `self` is `.json`.
                ///
                /// - Throws: An error if `self` is not `.json`.
                /// - SeeAlso: `.json`.
                public var json: Components.Responses.VersionsResponse.Body.jsonPayload {
                    get throws {
                        switch self {
                        case let .json(body):
                            return body
            ...
            /// Received HTTP response body
            public var body: Components.Responses.VersionsResponse.Body
            /// Creates a new `VersionsResponse`.
            ///
            /// - Parameters:
            ///   - body: Received HTTP response body
            public init(body: Components.Responses.VersionsResponse.Body) {
                self.body = body
            }
        }
        public struct VersionResponse: Sendable, Hashable {
            /// - Remark: Generated from `#/components/responses/VersionResponse/content`.
            @frozen public enum Body: Sendable, Hashable {
                /// Application version details
                ///
                /// - Remark: Generated from `#/components/responses/VersionResponse/content/json`.
                public struct jsonPayload: Codable, Hashable, Sendable {
                    /// Single version details
                    ///
                    /// - Remark: Generated from `#/components/responses/VersionResponse/content/json/version`.
                    public var version: Components.Schemas.Version
                    /// Creates a new `jsonPayload`.
                    ///
                    /// - Parameters:
                    ///   - version: Single version details
                ...
                case json(Components.Responses.VersionResponse.Body.jsonPayload)
                /// The associated value of the enum case if `self` is `.json`.
                ///
                /// - Throws: An error if `self` is not `.json`.
                /// - SeeAlso: `.json`.
                public var json: Components.Responses.VersionResponse.Body.jsonPayload {
                    get throws {
                        switch self {
                        case let .json(body):
                            return body
            ...
            /// Received HTTP response body
            public var body: Components.Responses.VersionResponse.Body
            /// Creates a new `VersionResponse`.
            ///
            /// - Parameters:
            ///   - body: Received HTTP response body
            public init(body: Components.Responses.VersionResponse.Body) {
                self.body = body
            }
        }
...
public enum Operations {
    ...
    public enum getApps {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Headers: Sendable, Hashable {
                ...
                public var App_hyphen_Bundle_hyphen_ID: Components.Parameters.AppBundleId?
                /// Preferred language for response content
                ///
                ...
                public init(
                    ...
                    App_hyphen_Bundle_hyphen_ID: Components.Parameters.AppBundleId? = nil,
    ...
    /// - Remark: HTTP `GET /v1/apps/{id}/updates`.
    /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/get(getAppUpdates)`.
    public enum getAppUpdates {
        public static let id: Swift.String = "getAppUpdates"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/GET/path`.
            public struct Path: Sendable, Hashable {
                /// Application ID
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/GET/path/id`.
                public var id: Components.Parameters.AppId
                /// Creates a new `Path`.
                ///
                /// - Parameters:
            ...
            public struct Headers: Sendable, Hashable {
                /// Client application version
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/GET/header/App-Version`.
                public var App_hyphen_Version: Components.Parameters.AppVersion?
                /// Bundle identifier in reverse domain notation
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/GET/header/App-Bundle-ID`.
                public var App_hyphen_Bundle_hyphen_ID: Components.Parameters.AppBundleId?
                /// Preferred language for response content
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/GET/header/Accept-Language`.
                public var Accept_hyphen_Language: Components.Parameters.AcceptLanguage?
                /// Apple App Store application identifier
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/GET/header/App-Store-ID`.
                public var App_hyphen_Store_hyphen_ID: Components.Parameters.AppStoreId?
                public var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.getAppUpdates.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - App_hyphen_Version: Client application version
                ...
                public init(
                    ...
                    Accept_hyphen_Language: Components.Parameters.AcceptLanguage? = nil,
                    App_hyphen_Store_hyphen_ID: Components.Parameters.AppStoreId? = nil,
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.getAppUpdates.AcceptableContentType>] = .defaultValues()
                ) {
                    self.App_hyphen_Version = App_hyphen_Version
                    self.App_hyphen_Bundle_hyphen_ID = App_hyphen_Bundle_hyphen_ID
                    self.Accept_hyphen_Language = Accept_hyphen_Language
            ...
            public var headers: Operations.getAppUpdates.Input.Headers
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - path:
        ...
        @frozen public enum Output: Sendable, Hashable {
            /// List of application versions
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/get(getAppUpdates)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            case ok(Components.Responses.VersionsResponse)
            /// The associated value of the enum case if `self` is `.ok`.
            ///
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Components.Responses.VersionsResponse {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
            ...
            /// Bad request
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/get(getAppUpdates)/responses/400`.
            ///
            /// HTTP response code: `400 badRequest`.
            case badRequest(Components.Responses.BadRequestResponse)
            /// The associated value of the enum case if `self` is `.badRequest`.
            ...
            /// Unauthorized - Invalid or missing API key
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/get(getAppUpdates)/responses/401`.
            ///
            /// HTTP response code: `401 unauthorized`.
            case unauthorized(Components.Responses.UnauthorizedResponse)
            /// The associated value of the enum case if `self` is `.unauthorized`.
            ...
            /// Not found
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/get(getAppUpdates)/responses/404`.
            ///
            /// HTTP response code: `404 notFound`.
            case notFound(Components.Responses.NotFoundResponse)
            /// The associated value of the enum case if `self` is `.notFound`.
            ...
            /// Internal server error
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/get(getAppUpdates)/responses/500`.
            ///
            /// HTTP response code: `500 internalServerError`.
            case internalServerError(Components.Responses.InternalServerErrorResponse)
            /// The associated value of the enum case if `self` is `.internalServerError`.
    ...
    /// - Remark: HTTP `GET /v1/apps/{id}/updates/{version}`.
    /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/{version}/get(getAppUpdate)`.
    public enum getAppUpdate {
        public static let id: Swift.String = "getAppUpdate"
        public struct Input: Sendable, Hashable {
            /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/{version}/GET/path`.
            public struct Path: Sendable, Hashable {
                /// Application ID
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/{version}/GET/path/id`.
                public var id: Components.Parameters.AppId
                /// Application version (semver)
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/{version}/GET/path/version`.
            ...
            public var path: Operations.getAppUpdate.Input.Path
            /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/{version}/GET/header`.
            public struct Headers: Sendable, Hashable {
                /// Client application version
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/{version}/GET/header/App-Version`.
                public var App_hyphen_Version: Components.Parameters.AppVersion?
                /// Bundle identifier in reverse domain notation
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/{version}/GET/header/App-Bundle-ID`.
                public var App_hyphen_Bundle_hyphen_ID: Components.Parameters.AppBundleId?
                /// Preferred language for response content
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/{version}/GET/header/Accept-Language`.
                public var Accept_hyphen_Language: Components.Parameters.AcceptLanguage?
                /// Apple App Store application identifier
                ///
                /// - Remark: Generated from `#/paths/v1/apps/{id}/updates/{version}/GET/header/App-Store-ID`.
                public var App_hyphen_Store_hyphen_ID: Components.Parameters.AppStoreId?
                public var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.getAppUpdate.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - App_hyphen_Version: Client application version
                ...
                public init(
                    ...
                    Accept_hyphen_Language: Components.Parameters.AcceptLanguage? = nil,
                    App_hyphen_Store_hyphen_ID: Components.Parameters.AppStoreId? = nil,
                    accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.getAppUpdate.AcceptableContentType>] = .defaultValues()
                ) {
                    self.App_hyphen_Version = App_hyphen_Version
                    self.App_hyphen_Bundle_hyphen_ID = App_hyphen_Bundle_hyphen_ID
                    self.Accept_hyphen_Language = Accept_hyphen_Language
            ...
            public var headers: Operations.getAppUpdate.Input.Headers
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - path:
        ...
        @frozen public enum Output: Sendable, Hashable {
            /// Application version details
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/{version}/get(getAppUpdate)/responses/200`.
            ///
            /// HTTP response code: `200 ok`.
            ...
            /// - Throws: An error if `self` is not `.ok`.
            /// - SeeAlso: `.ok`.
            public var ok: Components.Responses.VersionResponse {
                get throws {
                    switch self {
                    case let .ok(response):
                        return response
            ...
            /// Bad request
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/{version}/get(getAppUpdate)/responses/400`.
            ///
            /// HTTP response code: `400 badRequest`.
            case badRequest(Components.Responses.BadRequestResponse)
            /// The associated value of the enum case if `self` is `.badRequest`.
            ...
            /// Unauthorized - Invalid or missing API key
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/{version}/get(getAppUpdate)/responses/401`.
            ///
            /// HTTP response code: `401 unauthorized`.
            case unauthorized(Components.Responses.UnauthorizedResponse)
            /// The associated value of the enum case if `self` is `.unauthorized`.
            ...
            /// Not found
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/{version}/get(getAppUpdate)/responses/404`.
            ///
            /// HTTP response code: `404 notFound`.
            case notFound(Components.Responses.NotFoundResponse)
            /// The associated value of the enum case if `self` is `.notFound`.
            ...
            /// Internal server error
            ///
            /// - Remark: Generated from `#/paths//v1/apps/{id}/updates/{version}/get(getAppUpdate)/responses/500`.
            ///
            /// HTTP response code: `500 internalServerError`.
            case internalServerError(Components.Responses.InternalServerErrorResponse)
            /// The associated value of the enum case if `self` is `.internalServerError`.
